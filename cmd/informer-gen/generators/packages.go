...
func Packages(context *generator.Context, arguments *args.GeneratorArgs) generator.Packages {
	...
	internalVersionPackagePath := filepath.Join(arguments.OutputPackagePath, "internal")
	externalVersionPackagePath := arguments.OutputPackagePath
	...
	// NOTE(kdada): ingore factory_interfaces
	...
	// NOTE(kdada): ingore all internal packages
