...
var (
	...
	clientgoInterface                     = types.Name{Package: "k8s.io/client-go/kubernetes", Name: "Interface"}
	clientgoGenericInformer               = types.Name{Package: "k8s.io/client-go/informers", Name: "GenericInformer"}
	clientgoSharedInformerFactory         = types.Name{Package: "k8s.io/client-go/informers", Name: "SharedInformerFactory"}
	clientgoNewSharedInformerFactory      = types.Name{Package: "k8s.io/client-go/informers", Name: "NewSharedInformerFactory"}
	clientgoInternalSharedInformerFactory = types.Name{Package: "k8s.io/client-go/informers/internalinterfaces", Name: "SharedInformerFactory"}
)
