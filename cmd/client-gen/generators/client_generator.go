...
import (
	...
	"github.com/caicloud/clientset/cmd/client-gen/generators/fake"
	"github.com/caicloud/clientset/cmd/client-gen/generators/scheme"
...
func packageForClientset(customArgs clientgenargs.Args, clientsetPackage string, boilerplate []byte, generatedBy string) generator.Package {
	...
	kubernetesPackage := filepath.Join(customArgs.ClientsetOutputPath, customArgs.ClientsetName)

	return &generator.DefaultPackage{
		PackageName: customArgs.ClientsetName,
		PackagePath: kubernetesPackage,
		HeaderText:  boilerplate,
		PackageDocumentation: []byte(
			generatedBy +
