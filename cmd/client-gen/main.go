...
import (
	...
	clientgenargs "github.com/caicloud/clientset/cmd/client-gen/args"
	"github.com/caicloud/clientset/cmd/client-gen/generators"
	"github.com/caicloud/clientset/cmd/client-gen/types"
...
var (
	inputVersions          = flag.StringSlice("input", []string{}, "group/versions that client-gen will generate clients for. At most one version per group is allowed. Specified in the format \"group1/version1,group2/version2...\".")
	...
	clientsetName          = flag.StringP("clientset-name", "n", "kubernetes", "the name of the generated clientset package.")
	...
	fakeClient             = flag.Bool("fake-clientset", false, "when set, client-gen will generate the fake clientset that can be used in tests")
)
...
func main() {
	...
	arguments.GoHeaderFilePath = filepath.Join(args.DefaultSourceTree(), "github.com/caicloud/clientset/hack/boilerplate/boilerplate.go.txt")
	flag.Parse()
	var cmdArgs string
